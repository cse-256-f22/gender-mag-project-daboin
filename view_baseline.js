...
perm_dialog = define_new_dialog('permdialog', title='Edit Permissions', options = {
...
advanced_expl_div = $('<div id="permdialog_advanced_explantion_text">Click Advanced for special permissions or to check inherited traits from other users.</div>')
...
perm_dialog.append($('<div id="permissions_user_title">Select the group or user names:</div>'))
